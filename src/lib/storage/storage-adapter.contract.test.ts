...
export function data(): BetterMeData {
  return { schemaVersion: 1, habits: [], habitEntries: [], reflections: [], settings: { timezone: "UTC", startDate: "2026-01-01", selectedDate: "2026-01-01", trackerDays: 30, targetCompletionRate: 0.8, themeId: "cute-cat" }, updatedAt: "2026-01-01T00:00:00.000Z" };
}
